  ...
  return (
    <div>
      ...
      <div className='d-flex justify-content-between text-14 text-gray mt-4'>
        <span className='text-12' ref={minPrice}>{Number(500000).toLocaleString()} تومان </span>
        <span className='text-12' ref={maxPrice}>{Number(10000000).toLocaleString()}تومان </span>
      </div>
    </div>
  )
}
